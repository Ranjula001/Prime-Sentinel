...
const ProductsGallery = () => {
  ...
  return (
    <section
      className="relative mt-12 min-h-[680px] select-none overflow-hidden rounded-[38px] bg-[#070707] px-6 py-16 text-white md:px-10 lg:min-h-[740px] lg:px-16"
    ...
    >
      ...
      <div
        className={`relative z-10 mt-12 h-[520px] overflow-visible md:h-[560px] ${
      ...
      >
        <div className="pointer-events-none absolute left-1/2 top-1/2 h-[1px] w-[76%] -translate-x-1/2 rounded-full bg-gradient-to-r from-transparent via-[#DAB001]/50 to-transparent" />

        <div className="pointer-events-none absolute left-1/2 top-1/2 h-[500px] w-[940px] -translate-x-1/2 -translate-y-1/2 rounded-t-full border-t border-[#DAB001]/30 opacity-80" />
          ...
          {cards.map(
            ({
              ...
              <div
                ...
                className="absolute left-1/2 top-1/2 h-[360px] w-[260px] select-none"
                style={{
                  zIndex,
                  opacity,
              ...
              >
                ...
                >
                  <div className="relative h-full w-full select-none overflow-hidden rounded-[28px] border border-white/10 bg-[#111] shadow-[0_35px_90px_rgba(0,0,0,0.55)] transition-all duration-500 group-hover:-translate-y-2 group-hover:border-[#DAB001]/70">
                    <img
                      src={product.image}
                      alt={product.title}
                    ...
                    <div className="pointer-events-none absolute left-5 top-5 select-none rounded-full border border-white/15 bg-black/70 px-3 py-2 text-[10px] font-bold uppercase tracking-[0.16em] text-white/80">
                      {product.category}
                    </div>

                    <div className="pointer-events-none absolute bottom-0 left-0 right-0 select-none p-5">
                      <p className="select-none text-[11px] font-bold uppercase tracking-[0.2em] text-[#DAB001]">
                        {product.shortTitle}
                      </p>

                      <h4 className="mt-2 select-none text-2xl font-medium leading-none tracking-[-0.06em] text-white">
                        {product.title}
                      </h4>

                      <p
                        className="mt-3 line-clamp-3 select-none text-sm leading-5 text-white/65"
                        style={{
                      ...
                      <div className="mt-5 inline-flex select-none items-center gap-3 rounded-full bg-white px-4 py-3 text-[10px] font-bold uppercase tracking-[0.12em] text-black transition-colors duration-300 group-hover:bg-[#DAB001]">
                        View Details
                        <span>→</span>
                      </div>
                    </div>
